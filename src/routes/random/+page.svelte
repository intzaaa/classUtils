...
<style lang="postcss">
	...
	.list {
		@apply flex h-fit max-h-[50%] min-h-12 w-full shrink-0 grow-0 flex-row flex-wrap content-start items-stretch justify-start overflow-y-scroll p-2 md:!h-full md:!max-h-full md:!w-[calc(1024px-300px)] md:!content-stretch;
	}
	.item {
